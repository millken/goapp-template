...
// The fixtures above are realistic — pnpm sorts keys, so "vue" ends up last in
// dependencies and no admin dep is ever the final key. That means they never
// exercise the trailing-comma repair, and would pass even if
